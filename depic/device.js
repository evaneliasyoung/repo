...
function () {
  ...
  _createClass(Device, [{
    ...
    value: function getName() {
      ...
      var hwRatio = window.screen.height / window.screen.width;
    ...
    value: function getVersion() {
      ...
      var ver = ua.substr(ua.indexOf(' OS ') + 4, ua.indexOf(' like') - ua.indexOf(' OS ') - 4).replace(/_/g, '.');
      return ver !== undefined && ver !== null && ver !== '' ? ver : 'Unknown';
    }
  }, {
    key: "matchVersion",
    value: function matchVersion(min, max) {
      var minAr = min.split('.').map(function (e) {
        return parseInt(e);
      });
      var maxAr = max.split('.').map(function (e) {
        return parseInt(e);
      });
      var verAr = this.version.split('.').map(function (e) {
        return parseInt(e);
      });
      minAr.push(0);
      minAr.push(0);
